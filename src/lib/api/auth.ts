...
import { post, get } from '@/utils/api-helpers';
...
export const logoutUser = (data: any) => post('/users/logout', data);
export const authGoogleUser = (data: any) => get('/auth/google', data);